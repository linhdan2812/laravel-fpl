...
// Route::get('product/{id}', [ClientProductsController::class, 'detailProduct'])->name('client.detailProduct');

Route::middleware(['checkLogin2'])->group(function () {
    // chi tiết sản phẩm
    Route::get('product/{id}', [ClientProductsController::class, 'detailProduct'])->name('client.detailProduct');
    Route::get('logout', [loginController::class, 'logout'])->name('logout');
    Route::get('usersInfor', [loginController::class, 'userInfor'])->name('userinfor');
    // đổi mật khẩu
    Route::get('change-password/{id}', [loginController::class, 'getChange'])->name('getChangePass');
    Route::post('change-password/{id}', [loginController::class, 'postChange']);
    // Sản phẩm mới
});